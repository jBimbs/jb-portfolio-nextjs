          ...
          >
            ...
            >
              <div>
                ...
                <p className="text-lg text-primary-200">Bachelor of Science in Computer Science</p>
              </div>
            ...
            >
              <div>
                ...
                <div className="space-y-4">
                  <div className="relative pl-6 border-l-2 border-primary">
                    ...
                    <p className="text-yellow-300 text-sm mt-1">• Dean&apos;s Lister (1st - 4th Year)</p>
                  </div>
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="mt-6 bg-[#ff4654] hover:bg-[#e63e4d] text-white font-bold py-3 px-6 rounded-lg transition-colors duration-300 flex items-center justify-center gap-2"
              >        
